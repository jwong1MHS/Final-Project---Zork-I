...
def West_of_House():
    ...
    if option == "open":
        ...
        West_of_House()
    elif option == "open mailbox":
        print("Opening the mailbox reveals a small leaflet.")
        conditions["open_mailbox"] = True
        West_of_House()
    elif (option == "take leaflet") and (conditions["open_mailbox"] == True):
        print("Taken.\n")
        inventory.append("leaflet")
        West_of_House()
    elif (option == "drop leaflet") and ("leaflet" in inventory):
        print("Dropped.\n")
        ...
        print(f"I do not know what {option} is.")
        West_of_House()
...
def Forest_Path():
    ...
    if option == "south":
        ...
        Up_a_Tree()
    elif (option == "open egg") and ("egg" in inventory):
...
def Behind_House():
    ...
    if option == "open window":
        ...
        Behind_House()
    elif (option == "enter house") and (conditions["open_window"] == True):
        Kitchen()
...
def request(x, y):  #asks for the keycode to jump to a part of the game
